        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50/30 pb-32">
            ...
            <section className="relative overflow-hidden px-4 sm:px-6 md:px-8 pt-8 pb-16">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    >
                        <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-4 text-center shadow-lg border border-white/60">
                            <Users className="w-6 h-6 text-purple-600 mx-auto mb-2" />
                            <div className="text-2xl font-black text-slate-900">{artists.length}</div>
                            <div className="text-xs text-slate-600 font-medium">Total Artists</div>
                        </div>
                        <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-4 text-center shadow-lg border border-white/60">
                            <Music2 className="w-6 h-6 text-pink-600 mx-auto mb-2" />
                            <div className="text-2xl font-black text-slate-900">{genres.length - 1}</div>
                            <div className="text-xs text-slate-600 font-medium">Genres</div>
                        </div>
                        <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-4 text-center shadow-lg border border-white/60">
                            <TrendingUp className="w-6 h-6 text-orange-600 mx-auto mb-2" />
                            <div className="text-2xl font-black text-slate-900">{trendingArtists.length}</div>
                            <div className="text-xs text-slate-600 font-medium">Trending</div>
                        </div>
                        <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-4 text-center shadow-lg border border-white/60">
                            <Sparkles className="w-6 h-6 text-yellow-600 mx-auto mb-2" />
                            <div className="text-2xl font-black text-slate-900">{risingStars.length}</div>
                            <div className="text-xs text-slate-600 font-medium">Rising Stars</div>
                        </div>
                    </motion.div>
                </div>
            </section>
