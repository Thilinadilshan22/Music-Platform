    ...
    return (
        <div className="min-h-screen">
            ...
            <section className="relative overflow-hidden">
                ...
                >
                    <motion.div
                        ...
                        className="w-full h-full bg-gradient-to-br from-blue-50/30 via-white to-purple-50/20 dark:from-blue-950/30 dark:via-slate-950 dark:to-purple-950/20"
                    >
            ...
            <div className="bg-white dark:bg-slate-950 pb-32">
                {/* Search Bar Section */}
                <section className="px-4 sm:px-6 md:px-8 mb-8 pt-8">
