    ...
    <div className="flex-1 flex items-center justify-center px-4 sm:px-6 md:px-8 py-12">
      <div className="max-w-6xl w-full">
        ...
        >
          ...
          <p className="text-slate-600 dark:text-slate-300 text-lg sm:text-xl md:text-2xl max-w-3xl mx-auto font-medium">
          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl p-6 border border-slate-200/60 dark:border-slate-700/60 hover:border-purple-300 dark:hover:border-purple-600 hover:shadow-lg transition-all group theme-transition"
              >
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-8 sm:gap-12 mt-16 pt-12 border-t border-slate-200 dark:border-slate-700"
        >
          {[
            ...
            return (
              <div key={stat.label} className="text-center group">
                <div className="flex items-center justify-center gap-2 mb-2">
                  <StatIcon className="w-5 h-5 text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform" />
